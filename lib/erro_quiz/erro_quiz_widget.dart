...
class ErroQuizWidget extends StatefulWidget {
  const ErroQuizWidget({Key? key}) : super(key: key);

  @override
  _ErroQuizWidgetState createState() => _ErroQuizWidgetState();
}

class _ErroQuizWidgetState extends State<ErroQuizWidget> {
