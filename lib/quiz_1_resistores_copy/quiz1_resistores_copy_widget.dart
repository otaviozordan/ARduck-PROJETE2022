...
class Quiz1ResistoresCopyWidget extends StatefulWidget {
  const Quiz1ResistoresCopyWidget({Key? key}) : super(key: key);

  @override
  _Quiz1ResistoresCopyWidgetState createState() =>
      _Quiz1ResistoresCopyWidgetState();
}

class _Quiz1ResistoresCopyWidgetState extends State<Quiz1ResistoresCopyWidget> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'A tensão no resistor 2 é proxima de 3 V?  ',
                    textAlign: TextAlign.center,
