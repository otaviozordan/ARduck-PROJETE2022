import '../aprenda_multimetro/aprenda_multimetro_widget.dart';
                      ...
                      child: InkWell(
                        onTap: () async {
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AprendaMultimetroWidget(),
                            ),
                          );
                        },
                        child: Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(0, 55, 20, 0),
                            child: Text(
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(0, 5, 30, 30),
                            child: Text(
                      ...
                      child: InkWell(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(0, 0, 80, 30),
                              child: Text(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(0, 55, 150, 0),
                            child: Text(
                              'Cybersecurity',
                              style:
                                  FlutterFlowTheme.of(context).title2.override(
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(0, 0, 10, 30),
                            child: Text(
                              'Aprenda as bases da Cyber segurança',
                              style: FlutterFlowTheme.of(context)
                                  .subtitle2
                                  .override(
                                    fontFamily: 'Poppins',
